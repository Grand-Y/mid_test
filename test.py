...
def plot_metrics(delays, time_intervals, throughputs, delay_output_file='delays.png', throughput_output_file='throughput.png'):
    # Plot delays
    plt.figure(figsize=(10, 6))
    plt.plot(delays, linestyle='-', color='b')
    ...
    # Plot throughput
    plt.figure(figsize=(10, 6))
    plt.plot(time_intervals, throughputs, linestyle='-', color='r')
