...
#ifndef COMP_TOPIC_RCLCPP__MSG__DETAIL__LINES_RESULT__TRAITS_HPP_
#define COMP_TOPIC_RCLCPP__MSG__DETAIL__LINES_RESULT__TRAITS_HPP_
...
inline std::string to_yaml(const LinesResult & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const comp_topic_rclcpp::msg::LinesResult & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const comp_topic_rclcpp::msg::LinesResult & msg)
{
  return comp_topic_rclcpp::msg::to_yaml(msg);
}

template<>
inline const char * data_type<comp_topic_rclcpp::msg::LinesResult>()
{
  return "comp_topic_rclcpp::msg::LinesResult";
}

template<>
inline const char * name<comp_topic_rclcpp::msg::LinesResult>()
{
  return "comp_topic_rclcpp/msg/LinesResult";
}

template<>
struct has_fixed_size<comp_topic_rclcpp::msg::LinesResult>
...
template<>
struct has_bounded_size<comp_topic_rclcpp::msg::LinesResult>
...
template<>
struct is_message<comp_topic_rclcpp::msg::LinesResult>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // COMP_TOPIC_RCLCPP__MSG__DETAIL__LINES_RESULT__TRAITS_HPP_
