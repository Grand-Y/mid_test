...
bool comp_topic_rclcpp__msg__point_detect__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("comp_topic_rclcpp.msg._point_detect.PointDetect", full_classname_dest, 47) == 0);
  }
  comp_topic_rclcpp__msg__PointDetect * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of PointDetect */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("comp_topic_rclcpp.msg._point_detect");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointDetect");
