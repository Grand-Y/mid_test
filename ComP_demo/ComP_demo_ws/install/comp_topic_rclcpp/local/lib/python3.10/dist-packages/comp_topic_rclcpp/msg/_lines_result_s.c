...
bool comp_topic_rclcpp__msg__lane_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("comp_topic_rclcpp.msg._lane_result.LinesResult", full_classname_dest, 47) == 0);
  }
  comp_topic_rclcpp__msg__LinesResult * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LinesResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("comp_topic_rclcpp.msg._lane_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LinesResult");
  ...
  comp_topic_rclcpp__msg__LinesResult * ros_message = (comp_topic_rclcpp__msg__LinesResult *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
