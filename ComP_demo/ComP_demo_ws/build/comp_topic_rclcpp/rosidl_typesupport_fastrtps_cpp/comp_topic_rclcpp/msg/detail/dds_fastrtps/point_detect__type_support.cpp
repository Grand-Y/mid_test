...
#include "comp_topic_rclcpp/msg/detail/point_detect__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = comp_topic_rclcpp::msg::PointDetect;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const comp_topic_rclcpp::msg::PointDetect *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<comp_topic_rclcpp::msg::PointDetect *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PointDetect__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const comp_topic_rclcpp::msg::PointDetect *>(
...
static size_t _PointDetect__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PointDetect(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PointDetect__callbacks = {
...
static rosidl_message_type_support_t _PointDetect__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PointDetect__callbacks,
...
{
  return &comp_topic_rclcpp::msg::typesupport_fastrtps_cpp::_PointDetect__handle;
}
