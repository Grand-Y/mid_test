...
#include "comp_topic_rclcpp/msg/detail/yolo_piece__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const comp_topic_rclcpp::msg::YoloPiece & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  comp_topic_rclcpp::msg::YoloPiece & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = comp_topic_rclcpp::msg::YoloPiece;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const comp_topic_rclcpp::msg::YoloPiece *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<comp_topic_rclcpp::msg::YoloPiece *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _YoloPiece__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const comp_topic_rclcpp::msg::YoloPiece *>(
...
static size_t _YoloPiece__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_YoloPiece(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _YoloPiece__callbacks = {
...
static rosidl_message_type_support_t _YoloPiece__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_YoloPiece__callbacks,
...
{
  return &comp_topic_rclcpp::msg::typesupport_fastrtps_cpp::_YoloPiece__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, comp_topic_rclcpp, msg, YoloPiece)() {
  return &comp_topic_rclcpp::msg::typesupport_fastrtps_cpp::_YoloPiece__handle;
}
