...
cdr_serialize(
  const comp_topic_rclcpp::msg::LaneResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  comp_topic_rclcpp::msg::LaneResult & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_comp_topic_rclcpp
max_serialized_size_LaneResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = comp_topic_rclcpp::msg::LaneResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const comp_topic_rclcpp::msg::LaneResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<comp_topic_rclcpp::msg::LaneResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LaneResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const comp_topic_rclcpp::msg::LaneResult *>(
...
static size_t _LaneResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LaneResult(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LaneResult__callbacks = {
...
static rosidl_message_type_support_t _LaneResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LaneResult__callbacks,
...
{
  return &comp_topic_rclcpp::msg::typesupport_fastrtps_cpp::_LaneResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, comp_topic_rclcpp, msg, LaneResult)() {
  return &comp_topic_rclcpp::msg::typesupport_fastrtps_cpp::_LaneResult__handle;
}
