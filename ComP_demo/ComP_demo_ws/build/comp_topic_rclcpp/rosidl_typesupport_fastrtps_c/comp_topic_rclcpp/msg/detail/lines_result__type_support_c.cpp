...
using _LinesResult__ros_msg_type = comp_topic_rclcpp__msg__LinesResult;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LinesResult__ros_msg_type * ros_message = static_cast<const _LinesResult__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LinesResult__ros_msg_type * ros_message = static_cast<_LinesResult__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_comp_topic_rclcpp__msg__LinesResult(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LinesResult__ros_msg_type * ros_message = static_cast<const _LinesResult__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LinesResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_comp_topic_rclcpp__msg__LinesResult(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_comp_topic_rclcpp
size_t max_serialized_size_comp_topic_rclcpp__msg__LinesResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = comp_topic_rclcpp__msg__LinesResult;
    is_plain =
      (
...
static size_t _LinesResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_comp_topic_rclcpp__msg__LinesResult(
...
static message_type_support_callbacks_t __callbacks_LinesResult = {
...
static rosidl_message_type_support_t _LinesResult__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LinesResult,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, comp_topic_rclcpp, msg, LinesResult)() {
  return &_LinesResult__type_support;
}
