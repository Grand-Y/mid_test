...
public:
    ...
    {
        RCLCPP_INFO(this->get_logger(), "%saaaaaaaaaaaaaaa.", name.c_str());
        ...
        {
            RCLCPP_ERROR(this->get_logger(), "DATA_PATH or WORKSPACE has not been set");
            return;
        }
        ...
        {
            RCLCPP_ERROR(this->get_logger(), "There is no img.");
            return;
        }
