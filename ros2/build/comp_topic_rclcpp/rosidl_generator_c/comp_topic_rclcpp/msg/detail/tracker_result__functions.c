...
comp_topic_rclcpp__msg__TrackerResult__init(comp_topic_rclcpp__msg__TrackerResult * msg)
{
  ...
  // width
  if (!rosidl_runtime_c__double__Sequence__init(&msg->width, 0)) {
    comp_topic_rclcpp__msg__TrackerResult__fini(msg);
    return false;
  }
  // height
  if (!rosidl_runtime_c__double__Sequence__init(&msg->height, 0)) {
    comp_topic_rclcpp__msg__TrackerResult__fini(msg);
    return false;
  }
  return true;
...
comp_topic_rclcpp__msg__TrackerResult__fini(comp_topic_rclcpp__msg__TrackerResult * msg)
{
  ...
  // width
  rosidl_runtime_c__double__Sequence__fini(&msg->width);
  // height
  rosidl_runtime_c__double__Sequence__fini(&msg->height);
}
