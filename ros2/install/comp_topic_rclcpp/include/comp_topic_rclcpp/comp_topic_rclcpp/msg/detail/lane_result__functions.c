...
comp_topic_rclcpp__msg__LaneResult__init(comp_topic_rclcpp__msg__LaneResult * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    comp_topic_rclcpp__msg__LaneResult__fini(msg);
    return false;
  }
  // left1
...
comp_topic_rclcpp__msg__LaneResult__create()
{
  ...
  comp_topic_rclcpp__msg__LaneResult * msg = (comp_topic_rclcpp__msg__LaneResult *)allocator.allocate(sizeof(comp_topic_rclcpp__msg__LaneResult), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(comp_topic_rclcpp__msg__LaneResult));
  bool success = comp_topic_rclcpp__msg__LaneResult__init(msg);
  if (!success) {
...
comp_topic_rclcpp__msg__LaneResult__Sequence__init(comp_topic_rclcpp__msg__LaneResult__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  comp_topic_rclcpp__msg__LaneResult * data = NULL;

  if (size) {
    data = (comp_topic_rclcpp__msg__LaneResult *)allocator.zero_allocate(size, sizeof(comp_topic_rclcpp__msg__LaneResult), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = comp_topic_rclcpp__msg__LaneResult__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        comp_topic_rclcpp__msg__LaneResult__fini(&data[i - 1]);
      }
...
comp_topic_rclcpp__msg__LaneResult__Sequence__fini(comp_topic_rclcpp__msg__LaneResult__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      comp_topic_rclcpp__msg__LaneResult__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  comp_topic_rclcpp__msg__LaneResult__Sequence * array = (comp_topic_rclcpp__msg__LaneResult__Sequence *)allocator.allocate(sizeof(comp_topic_rclcpp__msg__LaneResult__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = comp_topic_rclcpp__msg__LaneResult__Sequence__init(array, size);
  if (!success) {
...
comp_topic_rclcpp__msg__LaneResult__Sequence__destroy(comp_topic_rclcpp__msg__LaneResult__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    comp_topic_rclcpp__msg__LaneResult__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
comp_topic_rclcpp__msg__LaneResult__Sequence__are_equal(const comp_topic_rclcpp__msg__LaneResult__Sequence * lhs, const comp_topic_rclcpp__msg__LaneResult__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!comp_topic_rclcpp__msg__LaneResult__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  comp_topic_rclcpp__msg__LaneResult__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(comp_topic_rclcpp__msg__LaneResult);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    comp_topic_rclcpp__msg__LaneResult * data =
      (comp_topic_rclcpp__msg__LaneResult *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!comp_topic_rclcpp__msg__LaneResult__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          comp_topic_rclcpp__msg__LaneResult__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!comp_topic_rclcpp__msg__LaneResult__copy(
