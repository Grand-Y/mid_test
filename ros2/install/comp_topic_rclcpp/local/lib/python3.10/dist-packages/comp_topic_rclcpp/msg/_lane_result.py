...
class Metaclass_LaneResult(type):
    """Metaclass of message 'LaneResult'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'comp_topic_rclcpp.msg.LaneResult')
            logger.debug(
...
class LaneResult(metaclass=Metaclass_LaneResult):
    """Message class 'LaneResult'."""
